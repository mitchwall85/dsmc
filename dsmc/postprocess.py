...
class POST_PROCESS:
    ...
    def __init__(self, vol_grid: np.array, wall_grid, wp: int, dt: float, output_dir: str):
    ...
    def plot_removed_particles(self, t_tw, alpha, removed_particles_time, removed_outlet, removed_inlet, average_window):
        ...
        plt.xlabel("Time [s]")
        plt.grid()
        plt.savefig(f"{self.output_dir}/ttw{t_tw}_alp{alpha}_removed_particles.png") 
        plt.close
